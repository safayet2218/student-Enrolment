                ...
                <div class="card-body overview">
                  ...
                  <div class="info-links">
                    <a class="website">
                      ...
                      <span style="font-family: vernada;font-size: 16px;">{{$student_profile ->student_fathername}}</span>
                    </a>
                    <a class="website">
                      <i class="icon-globe icon">Mother name :</i>
                      <span style="font-family: vernada;font-size: 16px;">{{$student_profile ->student_mothername}}</span>
                    </a>
                    <a class="website">
                      <i class="icon-globe icon"> Student Department :</i>
                      <span style="font-family: vernada;font-size: 16px;">{{convert_department($student_profile ->student_department)}}</span>
                    </a>
                    <a class="website">
                      <i class="icon-globe icon"> Student address :</i>
                      <span style="font-family: vernada;font-size: 16px;">{{$student_profile ->student_address}}</span>
                    </a>
                    <a class="website">
                      <i class="icon-globe icon"> Student admission year :</i>
                      <span style="font-family: vernada;font-size: 16px;">{{$student_profile ->student_admissionyear}}</span>
                    </a>
                  </div>
                </div>
              </div>
