          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown notification-drop-down" aria-labelledby="notificationDropdown">
              <a class="dropdown-item" href="{{URL::to('/viewprofile')}}">
                ...
                <span class="notification-text">View profile</span>
              </a>
              <a class="dropdown-item" href="{{URL::to('/setting')}}">
                <i class="fa fa-phone text-danger fa-fw"></i>
                <span class="notification-text">Setting</span>
              </a>
              <a class="dropdown-item" href="{{URL::to('/logout')}}">
                <i class="fa fa-phone text-danger fa-fw"></i>
                <span class="notification-text">Log Out</span>
              </a>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            ...
            <div class="details">
              <p class="user-name">Safayet Hossain</p>
